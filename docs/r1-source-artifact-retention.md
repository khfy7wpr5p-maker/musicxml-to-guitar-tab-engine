...
R1 introduced upload result schema `1.2.0`. R2 advances the additive result schema to `1.3.0` for the provisional arrangement artifact. The established runtime `contractVersion: 1.0.0` remains unchanged.
