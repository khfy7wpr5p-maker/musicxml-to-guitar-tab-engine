...
test('POLY production chain remains fail-closed for timing-affecting or unbounded directions', () => {
  for (const [name, direction] of [
    ...
    ['reordered-dynamics-direction', '<direction placement="below"><sound dynamics="17.78"/><staff>1</staff><direction-type><dynamics><pp/></dynamics></direction-type></direction>'],
