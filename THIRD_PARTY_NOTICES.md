...
- `@coderline/alphatab` 1.8.4 — Mozilla Public License 2.0. It is used by the staging/runtime Workbench renderer and is also copied into the generated GitHub Pages preview artifact as same-origin browser/font/soundfont assets. The preview artifact includes the upstream alphaTab license text and package metadata under `third-party/alphatab/`.
