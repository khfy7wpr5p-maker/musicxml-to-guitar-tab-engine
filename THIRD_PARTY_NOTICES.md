...
- `@coderline/alphatab` 1.8.4 — Mozilla Public License 2.0.
- `puppeteer-core` 25.3.0 — Apache License 2.0.
- MuseScore CLI, when runner-provided — GNU GPL-family upstream terms; it is
  not bundled or downloaded by this repository.
